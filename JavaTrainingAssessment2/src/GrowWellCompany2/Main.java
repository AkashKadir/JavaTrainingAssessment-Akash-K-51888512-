...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Number of people working under "+a+" : "+Employee.countPeople(arrObj,a));
	...
	static Employee[] getEmpData() {
		...
		for(int i=0;i<NOP;i++) {
			...
			d.setDept_code(split[3]);
			Employee emp = new Employee(Integer.parseInt(split[0]),split[1],LocalDate.parse(split[2]),d,split[4],Integer.parseInt(split[5]));			
			arrObj[i]=emp;
